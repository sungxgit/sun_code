...
namespace hjgxl
{
    public partial class Ftb : jp
    {
        ...
        {
            string sql = "select FBillNo,FName,khmc,xsdd,fworkshop,fitemid,FNumber,finterid,fqty,FDefaultLoc,FSPID,FGMPBatchNo,FModel from  v_xdxx where fworkshop='" + comboBox2.SelectedValue + "' and  fbillno like '%" + comboBox1.Text + "%' and LEFT(FNumber,7) in (select  FNumber from V_Gx  where FName='涂布')  and (fbillno like '%" + comboBox1.Text + "%' or FGMPBatchNo like '%" + comboBox1.Text + "%')";
        ...
        private void comboBox1_SelectionChangeCommitted(object sender, EventArgs e)
        {
            try
            {
                ...
                string cl = "select sum(FMcd) cl from  tgx  where FICMOBillNo='" + comboBox1.SelectedValue + "'  and FWork='涂布'";
        ...
        public Boolean lgxl()
        {
            ...
            try
                ...
                string sql1 = "select FComboBox,FInteger from v_gx where fname='涂布' and fnumber='" + wlid.Text.ToString() + "'";
        ...
        {
            string sql = "select FItemID,FName from  t_Department where fname like '%涂布%'";
          
            comboBox2.DataSource = sj.ds(sql, "cj", conn);
            comboBox2.DisplayMember = "FName";
            comboBox2.ValueMember = "FItemID";
            sql = "select fid,FName from t_BOS200000000  where fname like '%涂布%'";
            comboBox3.DataSource = sj.ds(sql, "gx", conn);
            comboBox3.DisplayMember = "fname";
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            conn.Close();
            string ptnr = "涂布|" + label6.Text + "|" + label8.Text + "|" + gctm.Text + "|" + jtmc.Text + "|" + Globals.usernm + "|" + jlrq.Text + "|" + jyy.Text + "|" + bc.Text + "|" + mcd.Text+"|"+ngx.Text+"|"+wlkd.Text;
            FPt pt = new FPt(ptnr);
            try
            {
        ...
        private void toolStripButton3_Click(object sender, EventArgs e)
        {
            ...
            string sql = "select FBillNo,FName,khmc,xsdd,fworkshop,fitemid,FNumber,finterid,fqty,FDefaultLoc,FSPID,FGMPBatchNo,FModel from  v_xdxx where fworkshop='" + comboBox2.SelectedValue + "' and  fbillno like '%" + comboBox1.Text + "%' and LEFT(FNumber,7) in (select  FNumber from V_Gx  where FName='涂布')";
        ...
        public void tlbl(string sql,SqlConnection conn,int zt,string msg)
        {
            ...
            string sql_icstockbillentry = "select FChkPassItem,FSourceInterId,FDCStockID,FDCSPID,FBrNo,FEntryID,FUnitID,FQty,FAuxQty,FItemID,FInterID,FQtyMust,FAuxQtyMust,FBatchNo,FSourceTranType,FSourceBillNo,FICMOBillNo,FICMOInterID,FCostOBJID from  ICStockBillEntry where 1=2";
            SqlDataAdapter icstockbillentry = new SqlDataAdapter(sql_icstockbillentry, conn);
            icstockbillentry.Fill(ds, "icstockbillentry");
            sb = new SqlCommandBuilder(icstockbillentry);
